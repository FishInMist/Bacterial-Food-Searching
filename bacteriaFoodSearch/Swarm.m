function bacteria = Swarm(Terrain)
    numofbac=5;
    NA=zeros(numofbac);
    dis=@(x,y)(x^2+y^2)^0.5;
            ...
            for j=1:numofbac
                if bac(j).cor ~= bac(i).cor
                    if j~=i && dis1(bac(j).cor, bac(i).cor)<=RR
                        ...
                        if j~=i && RR<dis1(bac(j).cor, bac(i).cor)&& dis1(bac(j).cor, bac(i).cor)<=RO
                        bac(i).uro=bac(i).uro+bac(j).v;
                        elseif j~=i && RO<dis1(bac(j).cor, bac(i).cor)&& dis1(bac(j).cor, bac(i).cor)<=RA
                        bac(i).ura=bac(i).ura+(bac(j).cor-bac(i).cor)/dis1(bac(i).cor, bac(j).cor);
                        end
                    end
                end
            end
        ...
        for i = 1: numofbac           
          ...
          elseif intera==1
             if bac(i).u == [0 0]
               ...
               if abs(roundn(bac(i).cor(1)+((bac(i).u(1)/dis2(bac(i).u))+(w*(bac(i).dc>0))*bac(i).v(1))*bac(i).dt,-1))<=30
                  bac(i).cor(1)=roundn(bac(i).cor(1)+((bac(i).u(1)/dis2(bac(i).u))+(w*(bac(i).dc>0))*bac(i).v(1))*bac(i).dt,-1);
               end
               if abs(roundn(bac(i).cor(2)+((bac(i).u(2)/dis2(bac(i).u))+(w*(bac(i).dc>0))*bac(i).v(2))*bac(i).dt,-1))<=30
                  bac(i).cor(2)=roundn(bac(i).cor(2)+((bac(i).u(2)/dis2(bac(i).u))+(w*(bac(i).dc>0))*bac(i).v(2))*bac(i).dt,-1);
               end
             end
          end
